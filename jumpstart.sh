...
sudo apt install autorecon burpsuite enum4linux flameshot gobuster golang libreoffice neo4j netexec nth onesixtyone peass pspy python3-pip remmina rlwrap smbmap terminator wpscan;
