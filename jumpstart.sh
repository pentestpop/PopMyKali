...
sudo apt install autorecon burpsuite enum4linux flameshot gobuster golang netexec nth onesistyone peass pspy python3-pip remmina rlwrap smbmap terminator wpscan;
